...
NATIVE       = -march=native
AVX2FLAGS    = -DUSE_AVX2 -mavx2 -mbmi -mfma
BMI2FLAGS    = -DUSE_AVX2 -mavx2 -mbmi -mbmi2 -mfma
AVX512FLAGS  = -DUSE_AVX512 -mavx512f -mavx512bw -mfma
VNNI512FLAGS = -DUSE_VNNI512 -DUSE_AVX512 -mavx512f -mavx512bw -mavx512vnni -mfma
