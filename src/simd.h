...
inline void    vec_storeu_epi (vepi16 *dst, const vepi16 src) { _mm512_storeu_si512(dst, src); }
...
inline void    vec_storeu_epi (vepi16 *dst, const vepi16 src) { _mm256_storeu_si256(dst, src); }
