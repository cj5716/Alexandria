...
inline vepi32  vec_slli_epi32 (const vepi32 vec, const int shift)    { return _mm512_slli_epi32(vec, shift); }
...
inline vepi32  vec_slli_epi32 (const vepi32 vec, const int shift)    { return _mm256_slli_epi32(vec, shift); }
