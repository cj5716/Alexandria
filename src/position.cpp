...
void UpdatePinsAndCheckers(Position *pos) {
    UpdatePinsAndCheckers<true >(pos, pos->side);
    UpdatePinsAndCheckers<false>(pos, pos->side ^ 1);
}
