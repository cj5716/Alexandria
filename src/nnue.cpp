...
void NNUE::init(const char* file) {
    ...
    if (nn) {
        ...
        read += fread(net.FTWeights, sizeof(int16_t), NUM_NNUE_INPUTS * L1_SIZE, nn);
        ...
        std::memcpy(net.FTWeights, &gEVALData[memoryIndex], NUM_NNUE_INPUTS * L1_SIZE * sizeof(int16_t));
        memoryIndex += NUM_NNUE_INPUTS * L1_SIZE * sizeof(int16_t);
