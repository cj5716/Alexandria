...
TUNE_PARAM(lmpImpMarginConst, 325, 100, 500, 50.0, 0.002)
TUNE_PARAM(lmpImpMarginMult, 125, 60, 140, 7.0, 0.002)
TUNE_PARAM(lmpImpMarginPower, 225, 150, 250, 10.0, 0.002)
TUNE_PARAM(lmpNonImpMarginConst, 175, 50, 300, 15.0, 0.002)
TUNE_PARAM(lmpNonImpMarginMult, 75, 50, 100, 5.0, 0.002)
TUNE_PARAM(lmpNonImpMarginPower, 200, 150, 250, 10.0, 0.002)

TUNE_PARAM(fpImpMarginQuadratic, 20, 0, 32, 2.0, 0.002)
TUNE_PARAM(fpImpMarginLinear, 23, 0, 26, 2.0, 0.002)
TUNE_PARAM(fpImpMarginConst, 57, 0, 54, 10.0, 0.002)
...
TUNE_PARAM(seMarginMult, 36, 5, 48, 3.0, 0.002)
TUNE_PARAM(seDeBase, 50, 0, 60, 8.0, 0.002)
TUNE_PARAM(seDePvCoeff, 300, 0, 450, 30.0, 0.002)
