...
TUNE_PARAM(histPruneDepth, 5, 3, 10, 0.5, 0.002)
TUNE_PARAM(histPruneImpQuadratic, 4096, 4000, 6000, 100.0, 0.002)
TUNE_PARAM(histPruneImpLinear, 4096, 2048, 8192, 200.0, 0.002)
TUNE_PARAM(histPruneImpConst, 4096, 0, 32768, 300.0, 0.002)
TUNE_PARAM(histPruneNonImpQuadratic, 4096, 4000, 6000, 100.0, 0.002)
TUNE_PARAM(histPruneNonImpLinear, 4096, 2048, 8192, 200.0, 0.002)
TUNE_PARAM(histPruneNonImpConst, 4096, 0, 32768, 300.0, 0.002)
