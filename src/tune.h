...
TUNE_PARAM(tacticalHistFactoriserScale, 16, 0, 64, 2, 0.002)
TUNE_PARAM(tacticalHistFactoriserMax, 2048, 2048, 20000, 300, 0.002)
TUNE_PARAM(tacticalHistBucketMax, 6144, 2048, 20000, 300, 0.002)
