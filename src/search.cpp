...
static inline void score_moves(S_Board* pos, Search_data* sd, Search_stack* ss, S_MOVELIST* move_list, int ttMove, int threshold) {
...
moves_loop:
	...
	score_moves(pos, sd, ss, move_list, ttMove, 0);
...
int Quiescence(int alpha, int beta, S_ThreadData* td, Search_stack* ss) {
	...
	score_moves(pos, sd, ss, move_list, ttMove, -107);
